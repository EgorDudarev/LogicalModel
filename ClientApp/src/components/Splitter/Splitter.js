...
class Splitter extends React.Component {
    ...
    componentDidMount() {
        ...
        } else if (typeof this.props.firstaryInitialSize !== "undefined") {
            if (this.props.percentage) {
                secondaryPaneSize = 100 - this.props.firstaryInitialSize;
            } else {
...
Splitter.propTypes = {
    ...
    firstaryInitialSize: PropTypes.number,
